...
<div className=" flex justify-around text-2xl py-7">
      <Link href="/" className=" flex h-24 mt-10 ">
        ...
        <nav className=" flex flex-col">
          <Link href="/dashboard/contacts">Україна, 21050,<br/>
                м. Вінниця, вул. Соборна, 59<br/>
                тел. (0432) 59-51-84,<br/>
                        (0432) 59-51-84,<br/>
                факс (0432) 59-53-49</Link>
          <Link className="mt-7" href="/dashboard/news">Зворотний зв’язок</Link>
          
        </nav>
        <div>
        <Link href="/dashboard/events">При використанні матеріалів<br/> посилання на сайт Асоціації<br/> ОСН м.Вінниці обов’язкове</Link>
        </div>
    </div>
        </div>
  )
